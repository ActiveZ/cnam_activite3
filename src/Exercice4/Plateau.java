...
public class Plateau {
    ...
    public void affichePlateau() {
        for (int y = 7; y >= 0; y--) {
            for (int x =0; x < 8; x++) {
                if (tabPlaleau[x][y] != null) {System.out.print("\t" + tabPlaleau[x][y].pAsc());}
        ...
        for (int i = 0; i < 8; i++) { // balayage horizontal (x)
            ...
            switch (i) {
                ...
                case 4: //rois
                    ...
                    tabPlaleau[4][7] = new Cavalier(false, new Position(4,7));
                    break;
                case 5: //fous
                ...
                case 7: //tours
                    ...
                    tabPlaleau[7][7] = new Tour(true, new Position(7,7));
                    break;
            }
        }
    }
